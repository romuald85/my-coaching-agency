 ...
 */
final class Version20200929170550 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Add image_name field to products table';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products ADD image_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products DROP image_name');

 ...
 */
final class Version20200925192349 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'user_id field nullable';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE user_id user_id INT NOT NULL');

 ...
 */
final class Version20201104180511 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Drop price_ht, price_ttc, tva fields from bill table';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill DROP price_ht, DROP tva, DROP price_ttc, CHANGE adress2 adress2 VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill ADD price_ht INT NOT NULL, ADD tva VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD price_ttc INT NOT NULL, CHANGE adress2 adress2 VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');

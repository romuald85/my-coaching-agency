 ...
 */
final class Version20201020203536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, reference INT NOT NULL, name VARCHAR(255) NOT NULL, quantity INT NOT NULL, date DATETIME NOT NULL, products LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', validate INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE command ADD name VARCHAR(255) NOT NULL, CHANGE user_id user_id INT NOT NULL, CHANGE reference reference VARCHAR(255) NOT NULL, CHANGE command command LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE command DROP name, CHANGE user_id user_id INT DEFAULT NULL, CHANGE reference reference VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE command command LONGTEXT CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE comments CHANGE created_at created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');

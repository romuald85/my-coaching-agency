 ...
 */
final class Version20201027135747 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Drop quantity field from command table';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE command DROP quantity');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE command ADD quantity INT NOT NULL');
        $this->addSql('ALTER TABLE comments CHANGE created_at created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
